...
-- 执行顺序: 第三个执行（在 01-qmg-schema.sql 之后）
-- ============================================
...
-- 7. 坐位右上肢抬起90度时间
INSERT INTO `questionnaire_item` (`name`, `key`, `category`, `display_order`) VALUES
('坐位右上肢抬起90度时间', 'armRaiseRight', 'limbs', 7);
...
-- 8. 坐位左上肢抬起90度时间
INSERT INTO `questionnaire_item` (`name`, `key`, `category`, `display_order`) VALUES
('坐位左上肢抬起90度时间', 'armRaiseLeft', 'limbs', 8);
...
-- 12. 平卧位右下肢抬起45度
INSERT INTO `questionnaire_item` (`name`, `key`, `category`, `display_order`) VALUES
('平卧位右下肢抬起45度', 'legRaiseRight', 'limbs', 12);
...
-- 13. 平卧位左下肢抬起45度
INSERT INTO `questionnaire_item` (`name`, `key`, `category`, `display_order`) VALUES
('平卧位左下肢抬起45度', 'legRaiseLeft', 'limbs', 13);
...
-- 提示
SELECT 'QMG 问卷配置数据初始化完成！' AS status;